...
- [Utils](#utils)
    - [`thefuck` \- Auto-correct miss-typed commands](#thefuckhttpsgithubcomnvbnthefuck-auto-correct-miss-typed-commands)
    - [`zoxide` \- Easy navigation *(better cd)*](#zoxidehttpsgithubcomajeetdsouzazoxide-easy-navigation-_better-cd_)
    - [`tldr` \- Community-maintained docs *(better `man`)*](#tldrhttpsgithubcomtldr-pagestldr-community-maintained-docs-_better-man_)
    - [`scc` \- Count lines of code *(better `cloc`)*](#scchttpsgithubcomboyterscc-count-lines-of-code-_better-cloc_)
    - [`exa` \- Listing Files *(better `ls`)*](#exahttpsgithubcomoghamexa-listing-files-_better-ls_)
    - [`duf` \- Disk Usage *(better `df`)*](#dufhttpsgithubcommuesliduf-disk-usage-_better-df_)
    - [`aria2` \- Download Utility *(better `wget`)*](#aria2httpsgithubcomaria2aria2-download-utility-_better-wget_)
    - [`bat` \- Reading Files *(better `cat`)*](#bathttpsgithubcomsharkdpbat-reading-files-_better-cat_)
    - [`diff-so-fancy` \- File Comparisons *(better `diff`)*](#diff-so-fancyhttpsgithubcomso-fancydiff-so-fancy-file-comparisons-_better-diff_)
    - [`entr` \- Watch for changes](#entrhttpsgithubcomeradmanentr-watch-for-changes)
    - [`exiftool` \- Reading + writing metadata](#exiftoolhttpsgithubcomexiftoolexiftool-reading-writing-metadata)
    - [`fdupes` \- Duplicate file finder](#fdupeshttpsgithubcomjbruchonjdupes-duplicate-file-finder)
    - [`fzf` \- Fuzzy file finder *(better `find`)*](#fzfhttpsgithubcomjunegunnfzf-fuzzy-file-finder-_better-find_)
    - [`hyperfine` \- Command benchmarking](#hyperfinehttpsgithubcomsharkdphyperfine-command-benchmarking)
    - [`just` \- Modern command runner *(better `make`)*](#justhttpsgithubcomcaseyjust-modern-command-runner-_better-make_)
    - [`jq` \- JSON processor](#jqhttpsgithubcomstedolanjq-json-processor)
    - [`most` \- Multi-window scroll pager *(better less)*](#mosthttpswwwjedsoftorgmost-multi-window-scroll-pager-_better-less_)
    - [`procs` \- Process viewer *(better ps)*](#procshttpsgithubcomdalanceprocs-process-viewer-_better-ps_)
    - [`rip` \- Deletion tool *(better rm)*](#riphttpsgithubcomnivekuilrip-deletion-tool-_better-rm_)
    - [`ripgrep` \- Search within files *(better `grep`)*](#ripgrephttpsgithubcomburntsushiripgrep-search-within-files-_better-grep_)
    - [`rsync` \- Fast, incremental file transfer](#rsynchttpsrsyncsambaorg-fast-incremental-file-transfer)
    - [`sd` \- Find and replace *(better `sed`)*](#sdhttpsgithubcomchmlnsd-find-and-replace-_better-sed_)
    - [`tre` \- Directory hierarchy *(better `tree`)*](#trehttpsgithubcomdduantre-directory-hierarchy-_better-tree_)
    - [`xsel` \- Access the clipboard](#xselhttpsgithubcomkfishxsel-access-the-clipboard)
- [CLI Monitoring and Performance Apps](#cli-monitoring-and-performance-apps)
    - [`bandwhich` \- Bandwidth utilization monitor](#bandwhichhttpsgithubcomimsnifbandwhich-bandwidth-utilization-monitor)
    - [`ctop` \- Container metrics and monitoring](#ctophttpsgithubcombcicenctop-container-metrics-and-monitoring)
    - [`bpytop` \- Resource monitoring *(better `htop`)*](#bpytophttpsgithubcomaristocratosbpytop-resource-monitoring-_better-htop_)
    - [`glances` \- Resource monitor + web and API](#glanceshttpsgithubcomnicolargoglances-resource-monitor-web-and-api)
    - [`gping` \- Interactive ping tool *(better `ping`)*](#gpinghttpsgithubcomorfgping-interactive-ping-tool-_better-ping_)
    - [`dua-cli` \- Disk usage analyzer and monitor *(better `du`)*](#dua-clihttpsgithubcombyrondua-cli-disk-usage-analyzer-and-monitor-_better-du_)
    - [`speedtest-cli` \- Command line speed test utility](#speedtest-clihttpsgithubcomsivelspeedtest-cli-command-line-speed-test-utility)
    - [`dog` \- DNS lookup client *(better `dig`)*](#doghttpsgithubcomoghamdog-dns-lookup-client-_better-dig_)
- [CLI Productivity Apps](#cli-productivity-apps)
    - [`browsh` \- CLI web browser](#browshhttpsgithubcombrowsh-orgbrowsh-cli-web-browser)
    - [`buku` \- Bookmark manager](#bukuhttpsgithubcomjarunbuku-bookmark-manager)
    - [`cmus` \- Music browser / player](#cmushttpsgithubcomcmuscmus-music-browser-player)
    - [`cointop` \- Track crypto prices](#cointophttpsgithubcomcointop-shcointop-track-crypto-prices)
    - [`ddgr` \- Search the web from the terminal](#ddgrhttpsgithubcomjarunddgr-search-the-web-from-the-terminal)
    - [`khal` \- Calendar client](#khalhttpsgithubcompimutilskhal-calendar-client)
    - [`mutt` \- Email client](#mutthttpsgitlabcommuttmuamutt-email-client)
    - [`newsboat` \- RSS / ATOM news reader](#newsboathttpsgithubcomnewsboatnewsboat-rss-atom-news-reader)
    - [`rclone` \- Manage cloud storage](#rclonehttpsgithubcomrclonerclone-manage-cloud-storage)
    - [`taskwarrior` \- Todo + task management](#taskwarriorhttpsgithubcomgothenburgbitfactorytaskwarrior-todo-task-management)
    - [`tuir` \- Terminal UI for Reddit](#tuirhttpsgitlabcomajaktuir-terminal-ui-for-reddit)
- [CLI Dev Suits](#cli-dev-suits)
    - [`httpie` \- HTTP / API testing testing client](#httpiehttpsgithubcomhttpiehttpie-http-api-testing-testing-client)
    - [`lazydocker` \- Full Docker management app](#lazydockerhttpsgithubcomjesseduffieldlazydocker-full-docker-management-app)
    - [`lazygit` \- Full Git management app](#lazygithttpsgithubcomjesseduffieldlazygit-full-git-management-app)
    - [`kdash` \- Kubernetes dashboard app](#kdashhttpsgithubcomkdash-rskdash-kubernetes-dashboard-app)
    - [`gdp-dashboard` \- Visual GDP debugger](#gdp-dashboardhttpsgithubcomcyrus-andgdb-dashboard-visual-gdp-debugger)
- [CLI External Sercvices](#cli-external-sercvices)
    - [`ngrok` \- Reverse proxy for sharing localhost](#ngrokhttpsngrokcom-reverse-proxy-for-sharing-localhost)
    - [`tmate` \- Share a terminal session via internet](#tmatehttpstmateio-share-a-terminal-session-via-internet)
    - [`asciinema` \- Recording + sharing terminal sessions](#asciinemahttpsasciinemaorg-recording-sharing-terminal-sessions)
    - [`navi` \- Interactive cheat sheet](#navihttpsgithubcomdenisidoronavi-interactive-cheat-sheet)
    - [`transfer.sh` \- Fast file sharing](#transfershhttpsgithubcomdutchcoderstransfersh-fast-file-sharing)
    - [`surge` \- Deploy a site in seconds](#surgehttpssurgesh-deploy-a-site-in-seconds)
    - [`wttr.in` \- Check the weather](#wttrinhttpsgithubcomchubinwttrin-check-the-weather)
- [CLI Fun](#cli-fun)
    ...
    - [`lolcat` \- Make console output raibow colored](#lolcathttpsgithubcombusylooplolcat-make-console-output-raibow-colored)
    - [`neofetch` \- Show system data and ditstro info](#neofetchhttpsgithubcomdylanarapsneofetch-show-system-data-and-ditstro-info)
